  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "ws": parse_ws,
        "singleDigitNumber": parse_singleDigitNumber,
        "multiDigitNumber": parse_multiDigitNumber,
        "naturalNumber": parse_naturalNumber,
        "integer": parse_integer,
        "decimal": parse_decimal,
        "realNumber": parse_realNumber,
        "number": parse_number,
      ...
      function parse_start() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, a, b) { return [a].concat(b); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_singleDigitNumber() {
        var result0;
        var pos0;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, a) { return parseInt(a); })(pos0.offset, pos0.line, pos0.column, result0);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_multiDigitNumber() {
        var result0, result1, result2;
        var pos0, pos1;
      ...
      function parse_naturalNumber() {
        var result0;
        var pos0;
        
        pos0 = clone(pos);
        result0 = parse_multiDigitNumber();
        if (result0 === null) {
          result0 = parse_singleDigitNumber();
        }
        if (result0 !== null) {
          result0 = (function(offset, line, column, a) { return parseInt(a); })(pos0.offset, pos0.line, pos0.column, result0);
        }
      ...
      function parse_integer() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, sign, n) { return parseInt(sign+n); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_decimal() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, x) { return parseFloat('0.'+x.join('')); })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_realNumber() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, int_part, decimal_part) { return int_part + decimal_part * (int_part >= 0 ? 1 : -1); })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
      ...
      function parse_statement() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, v) { return {tag:'var',name:v}; })(pos0.offset, pos0.line, pos0.column, result0);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, e, b) { return {tag:'if',expr:e,body:b} })(pos0.offset, pos0.line, pos0.column, result0[4], result0[10]);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
              if (result0 === null) {
                ...
                if (result0 !== null) {
                  result0 = (function(offset, line, column, e, v) { return {tag:'repeat',expr:e,body:v};})(pos0.offset, pos0.line, pos0.column, result0[4], result0[9]);
                }
                if (result0 === null) {
                  pos = clone(pos0);
                }
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, line, column, v, args) { return {tag:"call", name:v, args:args}; })(pos0.offset, pos0.line, pos0.column, result0[0], result0[3]);
              }
              if (result0 === null) {
                pos = clone(pos0);
              }
